...
function viewClass(row) {
  ...
  router.push({ name: 'class-detail', query })
}
            ...
            <tbody>
              <tr v-for="row in rows" :key="row.code">
                ...
                <td class="action-cell">
                  <button class="icon-btn" type="button" title="Xem" @click="viewClass(row)">
...
.btn-add {
  border: none; border-radius: 8px; background: #0f8f54; color: #fff; padding: 10px 14px; font-weight: 700; cursor: pointer;
}
...
.table-scroll { overflow: auto; min-height: 0; max-height: 380px; }
...
.major-chip {
  display: inline-flex; align-items: center; padding: 2px 10px; border-radius: 999px; background: #fdecf2; color: #b43262; border: 1px solid #f1c9d9; font-size: 12px; font-weight: 700;
}
